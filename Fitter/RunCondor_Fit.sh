...
python /data6/Users/yeonjoon/CMSSW_10_6_30/src/PUjetID/Fitter/extract_fit_allchannel.py --input $INDIR --output ${OUTDIR}/${2}_${4}/${1}_WP${3}/  --year $1 --wp $3 --syst $4 --order $2 
