...
crab_common.config.JobType.maxJobRuntimeMin  = 24000 
...
if __name__ == '__main__':
  ...
  for i, dataset in enumerate(samplelist):
    ...
    secondaryName = secondaryName.replace("RunIISummer20UL16NanoAODv9-","MCUL16JMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
    secondaryName = secondaryName.replace("20UL16JMENano_106X_mcRun2_asymptotic_v17","") #REMOVE GT. CHECK ITS UPDATED
