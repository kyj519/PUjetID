...
if __name__ == '__main__':
  ...
  for i, dataset in enumerate(samplelist):
    ...
    secondaryName = secondaryName.replace("RunIISummer20UL18NanoAODv9-","MCUL18JMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
    secondaryName = secondaryName.replace("20UL18JMENano_106X_upgrade2018_realistic_v16_L1v1","") #REMOVE GT. CHECK ITS UPDATED
