...
if __name__ == '__main__':
  ...
  for i, dataset in enumerate(samplelist):
    ...
    secondaryName = secondaryName.replace("RunIISummer20UL17NanoAODv9-","MCUL17JMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
    secondaryName = secondaryName.replace("20UL17JMENano_106X_mc2017_realistic_v9","") #REMOVE GT. CHECK ITS UPDATED
