...
if __name__ == '__main__':
  ...
  for i, dataset in enumerate(samplelist):
    ...
    secondaryName = secondaryName.replace("RunIISummer20UL16NanoAODAPVv9-","MCUL16APVJMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
    secondaryName = secondaryName.replace("20UL16APVJMENano_106X_mcRun2_asymptotic_preVFP_v11","") #REMOVE GT. CHECK ITS UPDATED
